class MPLSMulticast:
    def __init__(self, payload):
        """
        Initialize an MPLSMulticast object with the provided raw payload data.

        :param payload: bytes representing the raw MPLS multicast packet data.
        """
        if len(payload) < 4:
    ...
    def __str__(self):
        """Return a string representation of the MPLS Multicast packet."""
        return (
            f"MPLS Multicast Packet:\n"
            f"  Label: {self.label}\n"
